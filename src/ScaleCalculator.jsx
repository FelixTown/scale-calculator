...
export default function ScaleCalculator() {
  ...
  // Derived: new leads input (shown above comparison table)
  ...
  const leadsNew = newLeadsOverride !== null ? newLeadsOverride : Math.round(leadsPerMonth * (1 + leadLift))
        ...
        <div className="space-y-6">
          ...
          <Section title="Volume" subtitle="Side-by-side: where you are vs. where you'll be" accentColor="#6BF6FF" {...p}>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4 mb-6">
              <div>
                <div className="text-sm font-bold uppercase tracking-[0.12em] mb-2" style={{ color: palette.textSoft }}>Adjust new leads / mo</div>
                <div className="relative">
                  <input
                    type="number"
                    value={newLeadsOverride !== null ? newLeadsOverride : leadsNew}
                ...
                <div className="text-xs mt-1" style={{ color: palette.textSoft }}>default: auto from improvement level</div>
              </div>
              <div>
                <div className="text-sm font-bold uppercase tracking-[0.12em] mb-2" style={{ color: palette.textSoft }}>Adjust close rate lift %</div>
                <div className="relative">
                  <input
                    type="number"
                    value={closeRateLiftOverride !== null ? closeRateLiftOverride : (closeLift * 100)}
